...
/***/ "./src/modules/storeScore.js":
/*!***********************************!*\
  !*** ./src/modules/storeScore.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addScore\": () => (/* binding */ addScore),\n/* harmony export */   \"getScoreData\": () => (/* binding */ getScoreData)\n/* harmony export */ });\n/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api.js */ \"./src/modules/api.js\");\n\n\nconst GAME_ID = 'sSp7OrPloGUwv60DHsj2';\n\nconst addScore = async (name, value) => {\n  let answer;\n  if (GAME_ID !== '') {\n    const data = { user: `${name}`, score: parseInt(value, 10) };\n    const response = await (0,_api_js__WEBPACK_IMPORTED_MODULE_0__.postData)(`games/${GAME_ID}/scores/`, data);\n    answer = response.result;\n  }\n  return answer;\n};\n\nconst getScoreData = async () => {\n  let answer = [];\n  if (GAME_ID !== '') {\n    const data = await (0,_api_js__WEBPACK_IMPORTED_MODULE_0__.getData)(`games/${GAME_ID}/scores/`);\n    answer = data.result;\n  }\n  return answer;\n};\n\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/storeScore.js?");
